...
//  Modified by Neil Mansilla on 3/31/13.//  Copyright (c) 2013 Mashery. All rights reserved.
//
...
@synthesize titleForDealer = _titleForDealer;
...
- (void)viewDidLoad {
    ...
    self.titleLabel.textLabel.text = self.titleForDealer;
    self.locationLabel.textLabel.text = self.locationForDealer;
    self.summaryTextView.text = self.urlForDealer;
}
...
- (IBAction)addFavorite:(id)sender {
    if([self.client isLoggedIn]) {
        ...
        [newManagedObject setValue:self.titleForDealer forKey:@"title"];
